 ...
 * }
 * @psalm-type CombatUiCoreConfig = array{
 *     encore?: array{ // Webpack Encore integration used by the cui_assets() Twig function
 *         build_name?: scalar|Param|null, // The name of the Webpack Encore build to use for cui_assets() // Default: "combat_ui"
 *         entry?: scalar|Param|null, // The entry point to use for cui_assets() // Default: "combat-ui"
 *         build_path?: scalar|Param|null, // Directory containing the entrypoints.json of the Combat UI build. Defaults to the assets:install location of this bundle's prebuilt assets. // Default: "%kernel.project_dir%/public/bundles/combatuicore/build"
 *     },
 *     theme_guard?: bool|Param, // If true, the cui_theme() Twig function will throw an exception if the theme is not set in the request attributes. // Default: true
 *     component_defaults?: array<string, mixed>,
 * }
 ...
 *     combat_ui_core?: CombatUiCoreConfig,
